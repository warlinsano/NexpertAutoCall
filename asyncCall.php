...
//	echo "Records Found : ".($itemCount-1)."<br>";
	...
	{	
		...
		if($controls['stop']){
		   //	echo "<script type='text/javascript'>alert('se ha detenido');</script>";		
		   exit();
	    }
	...
	// 	echo "<script type='text/javascript'>alert('se ha pausado por un segungo: ".date('h:i:s')." ');</script>";
		sleep(1);
	endif;
	}
}
